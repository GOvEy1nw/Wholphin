...
- **gradle**: Combined defaultDebug/personalDebug Gradle build exceeded context-mode's 300-second RPC window; host build state and artifacts require recovery (from Wholphin)
- **gradle**: Relaunched Gradle with scoped host access; hidden build process 2592 started and redirected logs were created (from Wholphin)
